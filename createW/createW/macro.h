...
#define TIMER_LOAD_PROCESS	11110
#define TIMER_CHECK_BALANCE 11111
...
enum LparamMessage{  lParam_Get_Account = -1 , lParam_Exit_Dll = 333 , lParam_Close_Mapfile = 777 , lParam_Recognize_Error = 555 };
