...
*/
	...
	{
		//MYDWORD myValue;
		//myValue.dw32Small[0] = (DWORD32)htonl((DWORD32)(value >> 32));
		//myValue.dw32Small[1] = (DWORD32)htonl((DWORD32)value);
		//value = myValue.dw64Big; 
		//return value;
	...
	T bswap(T a)
	{
		if (sizeof(T) == 2) a = (T)htons((u_short)a);
		else if(sizeof(T) == 4) a = (T)htonl((u_long)a);
